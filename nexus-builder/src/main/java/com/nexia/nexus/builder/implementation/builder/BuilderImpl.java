package com.nexia.nexus.builder.implementation.builder;
...
import com.nexia.nexus.builder.exception.NBTParsingException;
import com.nexia.nexus.builder.implementation.Wrapped;
import com.nexia.nexus.builder.implementation.command.CommandSourceInfoImpl;
import com.nexia.nexus.builder.implementation.util.ImplementationUtilsImpl;
...
public class BuilderImpl implements Builder {
    ...
    @Override
    public CommandSourceInfo createCommandSourceInfo(CommandSender sender, @Nullable Entity executingEntity, Location location, NexusServer server) {
